...
// handful of items that have one) which equipment slot / tool-and-weapon
// category an item belongs in.
namespace ItemProperties {
    ...
    // ItemCategory::None for -1, any unrecognized itemId, or any real item
    // that isn't a sword/axe/pickaxe/shovel/hoe/bow/crossbow/trident/mace/
    // fishing rod -- see Enchantment.hpp, the one current consumer.
