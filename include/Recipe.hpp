...
// Stage A: matching against the player's own 2x2 personal-inventory crafting
// grid only (Player slots 1-4). No crafting-table block, no separate window,
// no recipe-book packets -- see docs/internal-documentation.md.
namespace Recipe {
    ...
    // Checks grid against every registered Stage A recipe. Returns false
